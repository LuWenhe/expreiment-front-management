    ...
    <div>
        ...
        >
            ...
            <el-dialog title="修改学生信息" :visible.sync="editStudentDiag" width="70%" :before-close="handleClose">
                ...
                <el-form label-position="left" label-width="100px" :model="editStudentInfo" :rules="rules" ref="editStudentInfo">
...
// 邮箱填写过滤
        ...
        async handleSearch(){
            ...
            await post(url,{ realName:this.realName,currentPage: this.pageInfo.pageNum, pageSize: this.pageInfo.pageSize}).then(res=>{
                this.pageInfo = {
                    // 当前页数
        ...
        editTeacher(formName){
            this.$refs[formName].validate(valid => {
                if (valid) {
                    console.log(JSON.stringify(this.editStudentInfo))
